...
class AutothonRetailLoginTest:
    ...
    def verifyProductSearch(self, productname):
        self.autothonRetailLoginPage.searchProduct(productname)

    def verifyCustSupport(self):
        self.autothonRetailLoginPage.clickOnHelp()
